  ...
  return (
    <div id='Location' className='max-w-[1400px] h-[500p] bg-red-100 mx-auto my-20 pt-16 lg:mb-[20%] md:mb-[35%] px-4 grid lg:grid-cols-3 gap-4'>
      ...
      <div className='grid grid-cols-2 col-span-2 gap-2'>
        <img className='object-cover w-full h-full' src="/static/images/restaurant3.jpg" alt="/" />
        <img className='row-span-2 object-cover w-full h-full' src="/static/images/restaurant1.jpg" alt="/" />
        <img className='object-cover w-full h-full' src="/static/images/restaurant2.jpg" alt="/" />
      </div>
    </div>
  )
}
